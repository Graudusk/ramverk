 ...
 */
class GeoJsonIpControllerPostTest extends TestCase
{
     ...
     */
    public function testGetGeoPostJsonError()
    {
        ...
        $res = $this->controller->geoJsonActionPost();
     ...
     * Test the route "index".
     */
    public function testGetGeoPostIPv4Json()
    {
        $this->di->get("request")->setGlobals(
            [
                'post' => [
     ...
     * Test the route "index".
     */
    public function testGetGeoPostIPv6Json()
    {
        $this->di->get("request")->setGlobals(
            [
                'post' => [
